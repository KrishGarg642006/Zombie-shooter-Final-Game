...
function preload(){
  ...
  shooterImg = loadAnimation("assets/1.png","assets/2.png","assets/3.png","assets/4.png","assets/5.png","assets/6.png")
  shooter_shooting = loadImage("assets/shooter_3.png")

  zombieImg = loadImage("assets/zombie.png")

  bgImg = loadImage("assets/backg.jpeg")
...
player = createSprite(displayWidth-1150, displayHeight-300, 50, 50);
 player.addAnimation("shooteralien",shooterImg);
   player.scale = 1.1
   player.debug = true
...
if(keyWentDown("space")){
  ...
  bullet.velocityX = 20
  bullet.debug = true
  bullet.setCollider("rectangle",50,50,300,300)
